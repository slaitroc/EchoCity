...
public class EcholocationManager : MonoBehaviour
{
    ...
    [Header("Grid Settings")] [Range(0.1f, 5.0f)] [SerializeField]
    ...
    private readonly float[] sphereFrequencies = new float[16];
    private readonly float[] sphereIntensities = new float[16];

    private readonly Vector4[] spherePositions = new Vector4[16];
    private readonly float[] sphereRadii = new float[16];
    ...
    private void Update()
    {
        ...
        for (var i = 0; i < count; i++)
        {
            ...
            sphereFrequencies[i] = activeSpheres[i].Frequency;
